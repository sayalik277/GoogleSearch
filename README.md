...
Code flow :
Created 3 html pages , Google Search , Google Image search and Google Advanced Search . 
Redirecting user request to Google search , if any data search is requested (Note : Data validation parameter not set)
Google Image search and Google Advanced Search redirecting the page to Google search main page (Note: Actual working as given in problem statement , still not developed)
